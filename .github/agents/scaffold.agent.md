...
### Entity (Model)
- **Location**: `src/Server/AI.Nova.Server.Api/Features/{FeatureName}/`
- **File**: `{EntityName}.cs`
- **Requirements**:
...
- **Migration**: 
  - Run: `dotnet ef migrations add {MigrationName} --output-dir Infrastructure/Data/Migrations --verbose` in `AI.Nova.Server.Api` project

### DTO
- **Location**: `src/Shared/AI.Nova.Shared/Features/{FeatureName}/`
...
**Location**: `src/Client/AI.Nova.Client.Core/Components/Pages/{FeatureName}/`
