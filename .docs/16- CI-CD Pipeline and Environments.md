...
✓ Builds entire solution (AI.Nova.slnx)
...
2. **Build & Package with Velopack**
   ...
   dotnet vpk pack \
     ...
     -e AI.Nova.Client.Windows.exe \  # Main executable
     -r win-x86 \                   # Runtime
...
1. **Setup Android Signing**
   ...
   - Save as AI.Nova.keystore in project directory
...
dotnet publish -c Release \
  ...
  -p:AndroidSigningKeyStore="AI.Nova.keystore" \
  -p:AndroidSigningKeyAlias=AI.Nova \
