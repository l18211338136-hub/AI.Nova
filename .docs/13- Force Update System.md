...
Welcome to **Stage 13** of the AI.Nova project getting started guide! In this stage, we'll explore the **Force Update System** - a critical feature that ensures all users are running compatible versions of your application.
...
**File**: [`src/Client/AI.Nova.Client.Core/Services/HttpMessageHandlers/RequestHeadersDelegatingHandler.cs`](/src/Client/AI.Nova.Client.Core/Services/HttpMessageHandlers/RequestHeadersDelegatingHandler.cs)
...
**File**: [`src/Client/AI.Nova.Client.Core/Extensions/IClientCoreServiceCollectionExtensions.cs`](/src/Client/AI.Nova.Client.Core/Extensions/IClientCoreServiceCollectionExtensions.cs)
...
**File**: [`src/Server/AI.Nova.Server.Api/RequestPipeline/ForceUpdateMiddleware.cs`](/src/Server/AI.Nova.Server.Api/RequestPipeline/ForceUpdateMiddleware.cs)
...
**File**: [`src/Server/AI.Nova.Server.Api/appsettings.json`](/src/Server/AI.Nova.Server.Api/appsettings.json)
...
**File**: [`src/Server/AI.Nova.Server.Api/ServerApiSettings.cs`](/src/Server/AI.Nova.Server.Api/ServerApiSettings.cs)
...
**File**: [`src/Client/AI.Nova.Client.Core/Services/HttpMessageHandlers/ExceptionDelegatingHandler.cs`](/src/Client/AI.Nova.Client.Core/Services/HttpMessageHandlers/ExceptionDelegatingHandler.cs)
...
**File**: [`src/Client/AI.Nova.Client.Core/Services/Contracts/IAppUpdateService.cs`](/src/Client/AI.Nova.Client.Core/Services/Contracts/IAppUpdateService.cs)
...
**File**: [`src/Client/AI.Nova.Client.Web/Infrastructure/Services/WebAppUpdateService.cs`](/src/Client/AI.Nova.Client.Web/Infrastructure/Services/WebAppUpdateService.cs)
...
**File**: [`src/Client/AI.Nova.Client.Windows/Services/WindowsAppUpdateService.cs`](/src/Client/AI.Nova.Client.Windows/Services/WindowsAppUpdateService.cs)
...
**File**: [`src/Client/AI.Nova.Client.Maui/Services/MauiAppUpdateService.cs`](/src/Client/AI.Nova.Client.Maui/Services/MauiAppUpdateService.cs)
...
**File**: [`src/Client/AI.Nova.Client.Core/Components/Layout/ForceUpdateSnackBar.razor`](/src/Client/AI.Nova.Client.Core/Components/Layout/ForceUpdateSnackBar.razor)
...
**File**: [`src/Client/AI.Nova.Client.Core/Components/Layout/ForceUpdateSnackBar.razor.cs`](/src/Client/AI.Nova.Client.Core/Components/Layout/ForceUpdateSnackBar.razor.cs)
