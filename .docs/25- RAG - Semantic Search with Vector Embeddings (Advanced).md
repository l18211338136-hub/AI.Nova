...
The project supports multiple embedding model providers. You configure them in `appsettings.json` under the `AI` section in the `AI.Nova.Server.Api` project.

### 3.1 LocalTextEmbeddingGenerationService (Default)

**Location**: [`src/Server/AI.Nova.Server.Api/Program.Services.cs`](/src/Server/AI.Nova.Server.Api/Program.Services.cs) (lines 367-372)
...
#### **OpenAI Embeddings**
**Configuration** in [`appsettings.json`](/src/Server/AI.Nova.Server.Api/appsettings.json):
```json
"OpenAI": {
...
**File Location**: [`src/Server/AI.Nova.Server.Api/Infrastructure/Data/AppDbContext.cs`](/src/Server/AI.Nova.Server.Api/Infrastructure/Data/AppDbContext.cs)
...
**File**: [`src/Server/AI.Nova.Server.Api/Features/Products/Product.cs`](/src/Server/AI.Nova.Server.Api/Features/Products/Product.cs)
...
**File**: [`src/Server/AI.Nova.Server.Api/Features/Products/ProductConfiguration.cs`](/src/Server/AI.Nova.Server.Api/Features/Products/ProductConfiguration.cs)
...
- **When enabled**: Creates a `vector(768)` column in the database
...
**File**: [`src/Server/AI.Nova.Server.Api/Features/Products/ProductEmbeddingService.cs`](/src/Server/AI.Nova.Server.Api/Features/Products/ProductEmbeddingService.cs)
...
**File**: [`src/Server/AI.Nova.Server.Api/Features/Products/ProductController.cs`](/src/Server/AI.Nova.Server.Api/Features/Products/ProductController.cs)
...
public void Configure(EntityTypeBuilder<Product> builder)
{
    ...
    builder.Property(p => p.Embedding)
           .HasColumnType("vector(768)"); // Adjust size based on your embedding model
