...
**Location**: [`/src/Client/AI.Nova.Client.Core/Components/Pages/Products/ProductsPage.razor`](/src/Client/AI.Nova.Client.Core/Components/Pages/Products/ProductsPage.razor)
...
**Location**: [`/src/Client/AI.Nova.Client.Core/Components/Pages/Products/ProductsPage.razor.cs`](/src/Client/AI.Nova.Client.Core/Components/Pages/Products/ProductsPage.razor.cs)

This file contains the **component logic** - all C# code for the component:

```csharp
using AI.Nova.Shared.Dtos.Products;
using AI.Nova.Shared.Controllers.Products;

namespace AI.Nova.Client.Core.Components.Pages.Products;
...
**Location**: [`/src/Client/AI.Nova.Client.Core/Components/Pages/Products/ProductsPage.razor.scss`](/src/Client/AI.Nova.Client.Core/Components/Pages/Products/ProductsPage.razor.scss)
...
#### Adding to NavBar
**Location**: [`/src/Client/AI.Nova.Client.Core/Components/Layout/NavBar.razor`](/src/Client/AI.Nova.Client.Core/Components/Layout/NavBar.razor)
...
**Location**: [`/src/Client/AI.Nova.Client.Core/Components/Layout/MainLayout.razor.items.cs`](/src/Client/AI.Nova.Client.Core/Components/Layout/MainLayout.razor.items.cs)
...
Some pages need access to native platform features (e.g., device info, native APIs). Instead of placing them in `AI.Nova.Client.Core` and using dependency injection or pub-sub patterns, you can create **platform-specific pages** directly in platform projects.

#### Example: AboutPage

The `AboutPage` demonstrates this pattern by existing in multiple platform projects:
- [`/src/Client/AI.Nova.Client.Maui/Components/Pages/AboutPage.razor`](/src/Client/AI.Nova.Client.Maui/Components/Pages/AboutPage.razor)
- [`/src/Client/AI.Nova.Client.Windows/Components/Pages/AboutPage.razor`](/src/Client/AI.Nova.Client.Windows/Components/Pages/AboutPage.razor)
- [`/src/Client/AI.Nova.Client.Web/Components/Pages/AboutPage.razor`](/src/Client/AI.Nova.Client.Web/Components/Pages/AboutPage.razor)
...
**In `AI.Nova.Client.Maui.csproj`, `AI.Nova.Client.Windows.csproj`, and `AI.Nova.Client.Web.csproj`:**
...
<Target Name="BuildCssFiles">
    <Exec Command="../AI.Nova.Client.Core/node_modules/.bin/sass Components:Components" />
</Target>
```
...
**Location**: [`/src/Client/AI.Nova.Client.Core/Styles/app.scss`](/src/Client/AI.Nova.Client.Core/Styles/app.scss)
...
**Location**: [`/src/Client/AI.Nova.Client.Core/Styles/abstracts/_bit-css-variables.scss`](/src/Client/AI.Nova.Client.Core/Styles/abstracts/_bit-css-variables.scss)
...
**Location**: [`/src/Client/AI.Nova.Client.Core/Components/Pages/AppPageBase.cs`](/src/Client/AI.Nova.Client.Core/Components/Pages/AppPageBase.cs)
