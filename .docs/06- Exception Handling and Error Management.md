...
Welcome to Stage 6! In this stage, you will learn about the comprehensive exception handling and error management system built into the AI.Nova project.
...
From [`src/Server/AI.Nova.Server.Api/Features/Identity/IdentityController.EmailConfirmation.cs`](/src/Server/AI.Nova.Server.Api/Features/Identity/IdentityController.EmailConfirmation.cs):
...
**Location:** [`src/Server/AI.Nova.Server.Api/Infrastructure/Extensions/KnownExceptionExtensions.cs`](/src/Server/AI.Nova.Server.Api/Infrastructure/Extensions/KnownExceptionExtensions.cs)
...
```json
{
  "type": "AI.Nova.Shared.Exceptions.TooManyRequestsException",
...
From [`src/Server/AI.Nova.Server.Api/Features/Identity/IdentityController.cs`](/src/Server/AI.Nova.Server.Api/Features/Identity/IdentityController.cs):
...
From [`src/Client/AI.Nova.Client.Core/Components/Pages/Identity/SignIn/SignInPanel.razor.cs`](/src/Client/AI.Nova.Client.Core/Components/Pages/Identity/SignIn/SignInPanel.razor.cs):
...
**Location:** [`src/Client/AI.Nova.Client.Core/Components/AppComponentBase.cs`](/src/Client/AI.Nova.Client.Core/Components/AppComponentBase.cs)
...
From [`src/Client/AI.Nova.Client.Core/Components/Pages/Identity/SignIn/SignInPanel.razor`](/src/Client/AI.Nova.Client.Core/Components/Pages/Identity/SignIn/SignInPanel.razor):
...
**Handled by:** `BitMessageBoxService` in [`ClientExceptionHandlerBase`](/src/Client/AI.Nova.Client.Core/Services/ClientExceptionHandlerBase.cs)
...
**Handled by:** `SnackBarService` in [`ClientExceptionHandlerBase`](/src/Client/AI.Nova.Client.Core/Services/ClientExceptionHandlerBase.cs)
...
**Location:** [`src/Client/AI.Nova.Client.Core/Components/AppErrorBoundary.razor`](/src/Client/AI.Nova.Client.Core/Components/AppErrorBoundary.razor)
...
**Location:** [`src/Server/AI.Nova.Server.Api/Infrastructure/Services/ServerExceptionHandler.cs`](/src/Server/AI.Nova.Server.Api/Infrastructure/Services/ServerExceptionHandler.cs)
...
```json
{
  "type": "AI.Nova.Shared.Exceptions.ResourceNotFoundException",
...
**Location:** [`src/Client/AI.Nova.Client.Core/Services/ClientExceptionHandlerBase.cs`](/src/Client/AI.Nova.Client.Core/Services/ClientExceptionHandlerBase.cs)
...
**Location:** [`src/Client/AI.Nova.Client.Web/Services/WebClientExceptionHandler.cs`](/src/Client/AI.Nova.Client.Web/Services/WebClientExceptionHandler.cs)
...
**Location:** [`src/Client/AI.Nova.Client.Maui/Services/MauiExceptionHandler.cs`](/src/Client/AI.Nova.Client.Maui/Services/MauiExceptionHandler.cs)
...
**Location:** [`src/Client/AI.Nova.Client.Windows/Services/WindowsExceptionHandler.cs`](/src/Client/AI.Nova.Client.Windows/Services/WindowsExceptionHandler.cs)
