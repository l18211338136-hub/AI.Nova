...
Welcome to Stage 15! In this stage, you'll learn about the comprehensive logging, observability, and health monitoring infrastructure built into the AI.Nova project.
...
This is implemented in [`src/Server/AI.Nova.Server.Api/Infrastructure/SignalR/AppHub.cs`](/src/Server/AI.Nova.Server.Api/Infrastructure/SignalR/AppHub.cs):
...
From [`src/Server/AI.Nova.Server.Shared/Extensions/Infrastructure/WebApplicationBuilderExtensions.cs`](/src/Server/AI.Nova.Server.Shared/Infrastructure/Extensions/WebApplicationBuilderExtensions.cs):
...
When running the project with .NET Aspire (via `AI.Nova.Server.AppHost`), the dashboard is automatically available at:

```
https://localhost:2206
```
...
From [`src/Server/AI.Nova.Server.Shared/Infrastructure/Extensions/WebApplicationExtensions.cs`](/src/Server/AI.Nova.Server.Shared/Infrastructure/Extensions/WebApplicationExtensions.cs):
...
From [`src/Server/AI.Nova.Server.Shared/Infrastructure/Extensions/WebApplicationBuilderExtensions.cs`](/src/Server/AI.Nova.Server.Shared/Infrastructure/Extensions/WebApplicationBuilderExtensions.cs):
...
The project includes a custom health check for storage in [`src/Server/AI.Nova.Server.Api/Infrastructure/Services/AppStorageHealthCheck.cs`](/src/Server/AI.Nova.Server.Api/Infrastructure/Services/AppStorageHealthCheck.cs):
