...
Welcome to Stage 20! In this stage, you'll learn about .NET Aspire and how it transforms both development and deployment experiences in this AI.Nova project.
...
**Location**: [`src/Server/AI.Nova.Server.AppHost/`](/src/Server/AI.Nova.Server.AppHost/)
...
// Main server project
var serverWebProject = builder.AddProject("serverweb", "../AI.Nova.Server.Web/AI.Nova.Server.Web.csproj")
...
if (builder.ExecutionContext.IsRunMode)
{
    ...
    builder.AddProject("clientwebwasm", "../../Client/AI.Nova.Client.Web/AI.Nova.Client.Web.csproj")
        .WithExplicitStart();
    ...
    builder.AddProject("clientwindows", "../../Client/AI.Nova.Client.Windows/AI.Nova.Client.Windows.csproj")
        .WithExplicitStart();
...
1. Open `Program.cs` in the `AI.Nova.Server.AppHost` project
...
**Location**: [`src/Server/AI.Nova.Server.AppHost/appsettings.Development.json`](/src/Server/AI.Nova.Server.AppHost/appsettings.Development.json)
...
- ❌ `AI.Nova.Server.Api` **does NOT** run on Docker
- ❌ `AI.Nova.Server.Web` **does NOT** run on Docker
...
3. Run this command in the terminal to clean previous Windows build artifacts:
   ...
   ```
4. Then run the `AI.Nova.Server.AppHost` project
