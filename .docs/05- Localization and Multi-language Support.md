...
#### Server API Resources (`src/Server/AI.Nova.Server.Api/Features/Identity/Resources/`)
...
The `AppDataAnnotationsValidator` (located in `src/Client/AI.Nova.Client.Core/Components/AppDataAnnotationsValidator.cs`) extends the validation system to:
...
Here's an actual example from the project (`src/Client/AI.Nova.Client.Core/Components/Pages/Categories/AddOrEditCategoryModal.razor`):
...
- Components: `src/Client/AI.Nova.Client.Core/Components/AppComponentBase.cs`
- Pages: `src/Client/AI.Nova.Client.Core/Components/Pages/AppPageBase.cs`
...
**Base class location**: `src/Server/AI.Nova.Server.Api/Infrastructure/Controllers/AppControllerBase.cs`
