...
**Location**: [`/AI.Nova.sln`](/AI.Nova.sln)

**Purpose**: The **full solution file** for Visual Studio that includes ALL projects in the workspace.

**Contains**:
- Server projects (`AI.Nova.Server.Web`, `AI.Nova.Server.Api`, `AI.Nova.Server.Shared`, `AI.Nova.Server.AppHost`)
- Client projects (`AI.Nova.Client.Core`, `AI.Nova.Client.Web`, `AI.Nova.Client.Maui`, `AI.Nova.Client.Windows`)
- Shared project (`AI.Nova.Shared`)
- Tests project (`AI.Nova.Tests`)
...
### 2.2 `AI.Nova.Web.slnf`

**Location**: [`/AI.Nova.Web.slnf`](/AI.Nova.Web.slnf)
...
- `AI.Nova.Server.Web`
- `AI.Nova.Server.Api`
- `AI.Nova.Server.Shared`
- `AI.Nova.Server.AppHost`
- `AI.Nova.Client.Core`
- `AI.Nova.Client.Web`
- `AI.Nova.Shared`
- `AI.Nova.Tests`
...
**Location**: [`/AI.Nova.slnx`](/AI.Nova.slnx)
...
<Using Include="AI.Nova.Shared.Dtos" />
<Using Include="AI.Nova.Shared.Exceptions" />
<!-- ... and many more -->
```
...
```json
{
    ...
    "dotnet.defaultSolution": "AI.Nova.Web.slnf",
...
- **Default Solution**: Uses `AI.Nova.Web.slnf` for faster load times
...
- **`build`**: Builds the `AI.Nova.Server.Web` project
...
```json
{
    "configurations": [
        {
            "name": "C#: AI.Nova.Server.Web Debug",
            "type": "dotnet",
            "request": "launch",
            "projectPath": "${workspaceFolder}/src/Server/AI.Nova.Server.Web/AI.Nova.Server.Web.csproj"
        },
        {
            "name": "C#: AI.Nova.Server.Api Debug",
            "type": "dotnet",
            "request": "launch",
            "projectPath": "${workspaceFolder}/src/Server/AI.Nova.Server.Api/AI.Nova.Server.Api.csproj"
        },
        {
            "name": ".NET MAUI",
            "type": "maui",
...
- **Custom AI.Nova patterns**:
  - `*Resource.designer.cs` (auto-generated from `.resx`)
  - `/src/Client/AI.Nova.Client.Core/Scripts/*.js` (generated from TypeScript)
  - `/src/Client/AI.Nova.Client.Maui/Platforms/Android/google-services.json` (sensitive Firebase config)
