...
Welcome to Stage 12 of the AI.Nova project tutorial! In this stage, you'll learn about Blazor rendering modes, pre-rendering capabilities, Progressive Web App (PWA) features, and how they all work together in this project.
...
1. **[`/src/Server/AI.Nova.Server.Web/Components/App.razor`](/src/Server/AI.Nova.Server.Web/Components/App.razor)** - The main entry point for Blazor Server, WebAssembly, Auto and Static SSR
2. **[`/src/Client/AI.Nova.Client.Web/wwwroot/index.html`](/src/Client/AI.Nova.Client.Web/wwwroot/index.html)** - The entry point for Blazor WebAssembly standalone mode
3. **[`/src/Client/AI.Nova.Client.Maui/wwwroot/index.html`](/src/Client/AI.Nova.Client.Maui/wwwroot/index.html)** - The entry point for Blazor Hybrid / MAUI
...
<link href="_content/AI.Nova.Client.Core/styles/app.css" rel="stylesheet" />
```
...
<script src="_content/AI.Nova.Client.Core/scripts/app.js"></script>
...
**File**: [`/src/Client/AI.Nova.Client.Web/wwwroot/service-worker.published.js`](/src/Client/AI.Nova.Client.Web/wwwroot/service-worker.published.js)
...
self.externalAssets = [
    ...
    { "url": "AI.Nova.Server.Web.styles.css" },
    { "url": "AI.Nova.Client.Web.bundle.scp.css" }
];
```
