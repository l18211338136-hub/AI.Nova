...
- [`src/Client/AI.Nova.Client.Core/appsettings.json`](/src/Client/AI.Nova.Client.Core/appsettings.json) - Client-side shared configuration
- [`src/Client/AI.Nova.Client.Core/appsettings.Development.json`](/src/Client/AI.Nova.Client.Core/appsettings.Development.json) - Development overrides
- [`src/Client/AI.Nova.Client.Core/appsettings.Production.json`](/src/Client/AI.Nova.Client.Core/appsettings.Production.json) - Production overrides

### Platform-Specific Client Configuration
- **Blazor WebAssembly**: 
  - [`src/Client/AI.Nova.Client.Web/appsettings.json`](/src/Client/AI.Nova.Client.Web/appsettings.json)
  - [`src/Client/AI.Nova.Client.Web/appsettings.Development.json`](/src/Client/AI.Nova.Client.Web/appsettings.Development.json)
  - [`src/Client/AI.Nova.Client.Web/appsettings.Production.json`](/src/Client/AI.Nova.Client.Web/appsettings.Production.json)
- **.NET MAUI**: 
  - [`src/Client/AI.Nova.Client.Maui/appsettings.json`](/src/Client/AI.Nova.Client.Maui/appsettings.json)
  - [`src/Client/AI.Nova.Client.Maui/appsettings.Development.json`](/src/Client/AI.Nova.Client.Maui/appsettings.Development.json)
  - [`src/Client/AI.Nova.Client.Maui/appsettings.Production.json`](/src/Client/AI.Nova.Client.Maui/appsettings.Production.json)
- **Windows**: 
  - [`src/Client/AI.Nova.Client.Windows/appsettings.json`](/src/Client/AI.Nova.Client.Windows/appsettings.json)
  - [`src/Client/AI.Nova.Client.Windows/appsettings.Development.json`](/src/Client/AI.Nova.Client.Windows/appsettings.Development.json)
  - [`src/Client/AI.Nova.Client.Windows/appsettings.Production.json`](/src/Client/AI.Nova.Client.Windows/appsettings.Production.json)

### Server Configuration
- **API Server**: 
  - [`src/Server/AI.Nova.Server.Api/appsettings.json`](/src/Server/AI.Nova.Server.Api/appsettings.json)
  - [`src/Server/AI.Nova.Server.Api/appsettings.Development.json`](/src/Server/AI.Nova.Server.Api/appsettings.Development.json)
  - [`src/Server/AI.Nova.Server.Api/appsettings.Production.json`](/src/Server/AI.Nova.Server.Api/appsettings.Production.json)
- **Web Server**:
  - [`src/Server/AI.Nova.Server.Web/appsettings.json`](/src/Server/AI.Nova.Server.Web/appsettings.json)
  - [`src/Server/AI.Nova.Server.Web/appsettings.Development.json`](/src/Server/AI.Nova.Server.Web/appsettings.Development.json)
  - [`src/Server/AI.Nova.Server.Web/appsettings.Production.json`](/src/Server/AI.Nova.Server.Web/appsettings.Production.json)
- **AppHost**: 
  - [`src/Server/AI.Nova.Server.AppHost/appsettings.json`](/src/Server/AI.Nova.Server.AppHost/appsettings.json)
  - [`src/Server/AI.Nova.Server.AppHost/appsettings.Development.json`](/src/Server/AI.Nova.Server.AppHost/appsettings.Development.json)
...
- Server.Web, Client.Web, Client.Windows & Client.Maui: [`src/Client/AI.Nova.Client.Core/Infrastructure/Extensions/IConfigurationBuilderExtensions.cs`](/src/Client/AI.Nova.Client.Core/Infrastructure/Extensions/IConfigurationBuilderExtensions.cs)
...
In [`src/Client/AI.Nova.Client.Core/appsettings.json`](/src/Client/AI.Nova.Client.Core/appsettings.json), client-specific settings are defined:

```json
{
    "ServerAddress": "http://localhost:5000/",
    "ServerAddress_Comment": "If you're running AI.Nova.Server.Web project, then you can also use relative urls such as / for Blazor Server and WebAssembly",
...
In [`src/Client/AI.Nova.Client.Maui/appsettings.json`](/src/Client/AI.Nova.Client.Maui/appsettings.json):
...
In [`src/Server/AI.Nova.Server.Api/appsettings.json`](/src/Server/AI.Nova.Server.Api/appsettings.json), you'll find comprehensive server settings:

```json
{
    "ConnectionStrings": {
        "mssqldb": "Data Source=(localdb)\\mssqllocaldb; Initial Catalog=AI.NovaDb;...",
...
```json
{
    ...
    "ConnectionStrings": {
        "Aspire__Comment": "Running AI.Nova.Server.AppHost `overrides` the following connection strings at runtime.",
        "mssqldb": "Data Source=(localdb)\\mssqllocaldb; Initial Catalog=AI.NovaDb;...",
...
**From `src/Server/AI.Nova.Server.AppHost/appsettings.Development.json`:**
```json
{
    "Parameters": {
...
**From `src/Client/AI.Nova.Client.Core/appsettings.json`:**
```json
{
...
2. Override in platform-specific files:
   - For MAUI: [`src/Client/AI.Nova.Client.Maui/appsettings.json`](/src/Client/AI.Nova.Client.Maui/appsettings.json)
   - For Web: [`src/Client/AI.Nova.Client.Web/appsettings.json`](/src/Client/AI.Nova.Client.Web/appsettings.json)
   - For Windows: [`src/Client/AI.Nova.Client.Windows/appsettings.json`](/src/Client/AI.Nova.Client.Windows/appsettings.json)
