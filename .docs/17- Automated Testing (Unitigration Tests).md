...
The test project is located at [`src/Tests/AI.Nova.Tests.csproj`](/src/Tests/AI.Nova.Tests.csproj) and contains:
...
<RunSettings>
    <RunConfiguration>
        <EnvironmentVariables>            
            ...
            <ConnectionStrings__sqlite>Data Source=AI.NovaDb.db;Mode=Memory;Cache=Shared;</ConnectionStrings__sqlite>
        </EnvironmentVariables>
    </RunConfiguration>
</RunSettings>
```
...
```yaml
- name: Run Tests
  run: dotnet test src/Tests/AI.Nova.Tests.csproj --configuration Release
