...
using AI.Nova.Client.Maui.Infrastructure.Services;
...
public static partial class MauiProgram
{
    public static MauiApp CreateMauiApp()
    {
        ...
        var builder = MauiApp.CreateBuilder();
            ...
            .UseSentry(options =>
            {
                var configuration = new ConfigurationBuilder().AddClientConfigurations(clientEntryAssemblyName: "AI.Nova.Client.Maui").Build();
                configuration.GetRequiredSection("Logging:Sentry").Bind(options);
            })
            .Configuration.AddClientConfigurations(clientEntryAssemblyName: "AI.Nova.Client.Maui");
        ...
        mauiApp.Services.GetRequiredService<PubSubService>()
            .Subscribe(ClientAppMessages.PAGE_DATA_CHANGED, async (args) =>
            {
                ...
                {
                    Application.Current!.Windows.First().Title = title ?? "AI.Nova";
                });
            });
