        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShortId = table.Column<int>(type: "integer", nullable: false, comment: "用于生成友好 URL 的短整型 ID"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<short>(type: "smallint", nullable: true, comment: "0:待付款, 1:已付款, 2:已发货, 3:已完成, 4:已取消, 5:退款中"),
