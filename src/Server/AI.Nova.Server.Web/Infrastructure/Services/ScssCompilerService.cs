...
namespace AI.Nova.Server.Web.Infrastructure.Services;
...
public class ScssCompilerService
{
    internal static async Task WatchScssFiles(WebApplication app)
    {
        ...
        var clientCorePath = Path.Combine(Environment.CurrentDirectory, "../../Client/AI.Nova.Client.Core");
        ...
        // but uses ../../Client/AI.Nova.Client.Web:../../Client/AI.Nova.Client.Web instead of .:.,
        ...
        if (Path.Exists(Path.Combine(Environment.CurrentDirectory, "../../Client/AI.Nova.Client.Maui/Components")))
            sassPathsToWatch.Add("../../Client/AI.Nova.Client.Maui/Components:../../Client/AI.Nova.Client.Maui/Components");

        if (Path.Exists(Path.Combine(Environment.CurrentDirectory, "../../Client/AI.Nova.Client.Windows/Components")))
            sassPathsToWatch.Add("../../Client/AI.Nova.Client.Windows/Components:../../Client/AI.Nova.Client.Windows/Components");

        if (Path.Exists(Path.Combine(Environment.CurrentDirectory, "../../Client/AI.Nova.Client.Web/Components")))
            sassPathsToWatch.Add("../../Client/AI.Nova.Client.Web/Components:../../Client/AI.Nova.Client.Web/Components");
