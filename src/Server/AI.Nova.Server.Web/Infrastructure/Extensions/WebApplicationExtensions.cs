...
using AI.Nova.Client.Core.Infrastructure.Services;
...
<sitemapindex xmlns=""http://www.sitemaps.org/schemas/sitemap/0.9"">
   <sitemap>
      <loc>{0}sitemap.xml</loc>
        ...
        {
            var urls = AssemblyLoadContext.Default.Assemblies.Where(asm => asm.GetName().Name?.Contains("AI.Nova.Client") is true)
