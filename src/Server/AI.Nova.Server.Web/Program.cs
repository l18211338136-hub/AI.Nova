using AI.Nova.Server.Web.Infrastructure.Services;
using AI.Nova.Client.Core.Infrastructure.Services.Contracts;

namespace AI.Nova.Server.Web;
...
public static partial class Program
{
    public static async Task Main(string[] args)
    {
        ...
        builder.Configuration.AddClientConfigurations(clientEntryAssemblyName: "AI.Nova.Client.Web");
